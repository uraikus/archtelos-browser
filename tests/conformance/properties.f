...
arr[text] func styleDigestFieldNames() {
    return ['display', 'color', 'background', 'fontSize', 'fontBold', 
        ...
        'transformBoxContent', 'appearanceAuto', 'fieldSizingContent', 'accentColor', 'transformOriginX', 'transformOriginY', 'listInside', 'listImageUrl', 'backgroundFixed', 'flexDirection', 
