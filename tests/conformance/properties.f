...
arr[text] func styleDigestFields(s:Style) {
    return [`${s.display}`, `${s.color}`, `${s.background}`, `${s.fontSize}`, 
        ...
        `${s.borderImageOutset}`, `${s.borderImageRepeat}`, 
        ...
        `${transformKey(s.transforms)}`, `${s.transformBoxContent}`, `${lenKey(s.transformOriginX)}`, 
        `${lenKey(s.transformOriginY)}`, 
        `${s.listInside}`, `${s.listImageUrl}`, `${s.backgroundFixed}`, 
...
arr[text] func styleDigestFieldNames() {
    return ['display', 'color', 'background', 'fontSize', 'fontBold', 
        ...
        'borderImageWidthLeft', 'borderImageOutset', 'borderImageRepeat', 
        ...
        'gridCols', 'gridRows', 'gridAreas', 'gridAutoCols', 'gridAutoRows', 
        ...
        'transformBoxContent', 'transformOriginX', 'transformOriginY', 'listInside', 'listImageUrl', 'backgroundFixed', 'flexDirection', 
